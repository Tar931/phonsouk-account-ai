...
from openai import OpenAI  # DeepSeek ໃຊ້ລະບົບ dly ກັບ OpenAI
...
# --- 3. CSS ຕົບແຕ່ງ UI (ເພີ່ມສີທີມ Dark Mode Gradient ຟ້າ-ມ່ວງ) ---
st.markdown("""
<style>
    /* ປ່ຽນສີພື້ນຫຼັງແອັບທັງໝົດ */
    .stApp {
        background-color: #050A18 !important;
        color: #FFFFFF !important;
    }

    /* ຕົບແຕ່ງກ່ອງ Metric (ຕົວເລກສະຫຼຸບ) */
    ...
    /* ປ່ຽນສີຕົວເລກ Metric ໃຫ້ເປັນ Gradient */
...
# --- ຫົວຂໍ້ (Header ປັບສີໃຫ້ເຂົ້າກັບ Theme) ---
header_text = """
