...
# --- ດຶງເອົາສະໝອງກົນ AI ເຂົ້າມາ (ປ່ຽນມາໃຊ້ລຸ້ນ gemini-pro ທີ່ສະຖຽນທີ່ສຸດ) ---
ai_error_msg = ""
try:
    import google.generativeai as genai
    genai.configure(api_key=st.secrets["GEMINI_API_KEY"])
    # ປ່ຽນຊື່ AI ເປັນ gemini-pro ເພື່ອແກ້ບັນຫາ 404 Not Found
            ...
            if st.button("✨ ໃຫ້ AI ຊ່ວຍວິເຄາະບັນຊີ ແລະ ວາງແຜນການເງິນ", use_container_width=True):
                with st.spinner("🤖 ທີ່ປຶກສາ AI ກຳລັງຄິດຄຳນວນຈາກຕົວເລກຈິງຂອງປ້າ..."):
                    ...
                    try:
                        ...
                        st.error(f"ເກີດຂໍ້ຜິດພາດໃນການເຊື່ອມຕໍ່ AI: ກະລຸນາລອງໃໝ່ອີກຄັ້ງ ({e})")
    else:
